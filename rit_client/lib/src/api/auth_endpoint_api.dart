...
class AuthEndpointApi {
  ...
  Future<Response<LoginResponseDTO>> login({ 
    ...
    final _path = r'/v1/rit/users/auth/login';
    ...
    try {
_bodyData=jsonEncode(loginRequestDTO);
...
_responseData = rawData == null ? null : deserialize<LoginResponseDTO, LoginResponseDTO>(rawData, 'LoginResponseDTO', growable: true);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> registerInit({ 
    ...
    final _path = r'/v1/rit/users/auth/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
_bodyData=jsonEncode(registerRequestDTO);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
  ...
  /// Returns a [Future] containing a [Response] with a [LoginResponseDTO] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LoginResponseDTO>> userRegisterConfirmOtp({ 
    ...
    final _path = r'/v1/rit/users/auth/register/otp';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
_bodyData=jsonEncode(registerOtpRequestDTO);
    } catch(error, stackTrace) {
      throw DioException(
         requestOptions: _options.compose(
          _dio.options,
